...
export default function CharacterModal({ character, onClose }) {
  ...
  return (
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby={`character-title-${character.id}`}>
      <div className="character-modal">
        ...
        <h2 id={`character-title-${character.id}`}>{character.name}</h2>
